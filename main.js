...
const providerOptions = {
    walletconnect: {
        ...
        options: {
            ...
            qrcode: false, // Nonaktifkan QR Code di mobile agar langsung membuka app
            mobileLinks: ["trust", "metamask", "safepal", "rainbow", "argent", "ledger"]
        }
    }
};
...
// Fungsi koneksi WalletConnect V2
...
async function connectMetaMask() {
    if (window.ethereum) {
        ...
        alert("MetaMask tidak terpasang. Silakan install terlebih dahulu!");
    }
}

// Update UI setelah koneksi berhasil
...
// Cek status koneksi wallet saat halaman dimuat
...
// Event listener untuk tombol koneksi
...
const sttaddr = "0x857C588260DDD9934F40c90BC41a1FA4Da2e8b31";
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
    fresh = "0x81c9B6D72D6196CFb8A8F4605cea554a05eA30eC";
...
const buystt = async () => {
  ...
  let fresh = document.getElementById('airinput').value;
  if(fresh === "")
    fresh = "0x857C588260DDD9934F40c90BC41a1FA4Da2e8b31";
...
window.onload=function(){ 
 ...
 function getreflink(){
  document.getElementById('refaddress').value = 'https://testair123.netlify.app/?ref=' + document.getElementById('refaddress').value;
}
