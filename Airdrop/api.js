...
// 2️⃣ Koneksi Wallet dengan Web3Modal
...
// 4️⃣ Cek Koneksi Wallet Sebelum Aksi
...
async function buyToken() {
    ...
    try {
        await contractInstance.methods.tokenSale(userAccount, referrer || "0x0000000000000000000000000000000000000000").send({
            from: userAccount,
            value: valueInWei
        });
